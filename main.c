...
const char* hand_to_string(hands hand) {
    switch (hand) {
        ...
        default: return "UNKNOWN";  // In case of an invalid value
    }
}
...
int main(int argc, char const *argv[])
{
    ...
    printf("Do you want to play rock paper scissors with me? type 'y' if yes, and 'n' if no!\n");
    ...
    if (decision_to_play == 'y')
    {
        ...
        while (1)
        {
            ...
            hands computer_hand = 0 + rand() % (2 - 0 + 1); //random number in range [0,2]
